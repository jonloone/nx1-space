 ...
 * Demonstrates Phase 1 satellite imagery capabilities
 */
      ...
      <div className="absolute top-6 left-6 z-50">
        <div className="bg-gray-900/95 backdrop-blur border border-gray-800 rounded-lg px-6 py-4">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h1 className="text-lg font-semibold text-white">Space Domain - Phase 1 Test</h1>
              <p className="text-xs text-gray-400">Real Sentinel-2 satellite imagery via AWS STAC API</p>
            </div>
          </div>
      ...
      {!selectedLocation && (
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-30">
          <div className="bg-gray-900/95 backdrop-blur border border-gray-800 rounded-lg px-6 py-4 max-w-lg">
            <h3 className="text-sm font-medium text-white mb-2">Welcome to Space Domain Testing</h3>
