 ...
 */
export const AWS_GROUND_STATIONS = [
    {
 ...
 */
export const TELESAT_GROUND_STATIONS = [
    {
 ...
 */
export const STARLINK_GROUND_STATIONS = [
    {
 ...
 */
export const KSAT_GROUND_STATIONS = [
    {
 ...
 */
export const ALL_COMPETITOR_STATIONS = [
    ...AWS_GROUND_STATIONS,
 ...
 */
export function getCompetitorsByThreatLevel(threatLevel) {
 ...
 */
export function getCompetitorsByOperator(operator) {
 ...
 */
export function getCompetitorsInRadius(centerLat, centerLon, radiusKm) {
